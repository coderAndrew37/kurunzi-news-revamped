...
// Imports from the new split structure:
//   getSportsPosts  ← lib/wordpress.ts
//   ArticleLink     ← no change needed (already correct)
        ...
        <div className="flex-1 overflow-hidden py-1">
          <div className="flex whitespace-nowrap items-center">
            <div className="flex animate-ticker gap-12 pl-8 hover:[animation-play-state:paused]">
              ...
              {/* Duplicate for seamless loop on short lists */}
